...
public class SalesDetailsRepositoryImpl implements SalesDetailsRepository {
    ...
    public void deleteSaleDetails(Integer saleDetailsId) {
        try {
            ...
            PreparedStatement deleteSaleDetails = connection.prepareStatement(
                    "DELETE FROM sales_details WHERE sale_details_id = ?"
            );
            deleteSaleDetails.setObject(1, saleDetailsId);
            deleteSaleDetails.executeUpdate();
