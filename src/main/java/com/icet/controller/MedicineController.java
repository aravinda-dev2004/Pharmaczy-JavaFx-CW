...
import com.icet.service.impl.MedicineServiceImpl;
...
public class MedicineController implements Initializable {
    ...
    void btnDeleteMedicineOnAction(ActionEvent event) {
        Medicine selectedMedicine = tblMedicine.getSelectionModel().getSelectedItem();
    ...
    private void showError(String message) {
        ...
        alert.setTitle("Error - Pharmaczy");
    ...
    private void showSuccess(String message) {
        ...
        alert.setTitle("Success - Pharmaczy");
        alert.setHeaderText(message);
        alert.show();
    }
    ...
    void btnDashboardOnAction(ActionEvent event) {
        navigateTo("/view/dashboard_form.fxml", "Pharmaczy - Dashboard", event);
    }

    @FXML
    void btnInventoryOnAction(ActionEvent event) {
        navigateTo("/view/inventory_form.fxml", "Pharmaczy - Inventory", event);
    }

    @FXML
    void btnMedicineOnAction(ActionEvent event) {
        navigateTo("/view/medicine_form.fxml", "Pharmaczy - Medicine", event);
    }

    @FXML
    void btnSupplierOnAction(ActionEvent event) {
        navigateTo("/view/supplier_form.fxml", "Pharmaczy - Supplier", event);
    }

    @FXML
    void btnSalesBillingOnAction(ActionEvent event) {
        navigateTo("/view/sales_and_billing_form.fxml", "Pharmaczy - Sales & Billing", event);
    }

    @FXML
    public void btnSaleDetailsOnAction(ActionEvent event) {
        navigateTo("/view/sales_details_form.fxml", "Pharmaczy - Sale Details", event);
    }
}